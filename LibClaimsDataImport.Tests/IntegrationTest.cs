...
public class IntegrationTests
{
    ...
    private static async Task ValidateImportedData(string connectionString)
    {
        ...
        SqliteCommand maxCommand = connection.CreateCommand();
        ...
        Assert.True(DateTime.TryParse(maxDateString, out DateTime maxDate), $"Could not parse max date: {maxDateString}");
